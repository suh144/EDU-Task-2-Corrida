...
**Team:** Edu Track2 Corrida — Maneesh (Team Lead), Suha, Daria
**Event:** MentorME Futura Remix Hackathon — Brisbane, September 2026
**Track:** Track 2 — Education and Student Success
**Submission deadline:** 2:30pm Sunday, 6 September 2026
...
1. **De-skilling** — students don't build genuine understanding of the material because they never attempt the reasoning themselves.
2. **Academic integrity risk** — many assessments explicitly prohibit using AI to generate answers, leaving students without a safe, sanctioned way to use AI for study support.
...
1. Reads and previews the material — showing the topics it covers and a suggested number of study checkpoints
2. Lets the student adjust the number of checkpoints and optionally focus on a specific topic
3. Breaks the material into checkpoints, each with:
...
4. Everything is grounded strictly in the student's own uploaded material — not a generic AI answer pulled from elsewhere
